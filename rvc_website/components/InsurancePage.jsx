    ...
    <>
      <section class="h-[100vh] w-[100%] absolute">
        ...
        <div class='pl-[7%] pr-[7%] static mt-[1%] rounded-md justify-center'>
            <div class='flex flex-col items-center text-black justify-center font-<K2D> text-5xl pb-[25px]'>
                <div class="flex flex-row pb-[10px] w-[100%] justify-left">
                <div class="mr-[2%] text-black text-2xl font-semibold">Care Credit</div>
                </div>
                <div class="flex flex-col w-[100%] justify-left mb-[10px]">
                    <div class="text-lg mb-[10px]">As a service to our patients, we are pleased to offer the CareCredit card, the nation's leading patient payment program. CareCredit lets you begin your procedure immediately—then pay for it over time with low monthly payments that are easy to fit into your monthly budget.</div>
                </div>
            </div>
        </div>
      </section>
