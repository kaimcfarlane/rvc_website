  ...
  return (
    ...
    <section class="h-[100vh] w-[100%] absolute">
      ...
      <div class='w-[45%] h-[50%] p-[20px] static ml-[50%] mt-[15%] rounded-md justify-center'>
        <div class='flex flex-col items-center text-black justify-center font-<K2D> text-[3.18vw] pb-[25px]'>
        ...
        <div class='flex text-black justify-center font-<K2D> text-[1.99vw] leading-[2.38vw] pt-[20px] pb-[27px]'>
          <div class="">
    ...
    <section class="top-[100%] h-[100vh] w-[100%] absolute">
      <div>
        <Image src={DoctorHeadshot} class="w-[22.3vw] h-[33.2vw] z-1 absolute top-[22%] left-[65%] border-solid border-secondary rounded-lg border-4 shadow-lg" alt='DocPatientPic1'></Image>
      </div>
