  ...
  return (
    <>
      <section class="h-[100vh] w-[100%] absolute">
        ...
        <div class="absolute z-1 top-[27%] left-[55%] border-solid border-grey rounded-md border-8 shadow-xl">
        ...
        <div class="absolute ml-[10%] mt-[13%]">
        ...
        <div className='card w-96 bg-primary shadow-xl static ml-[10%] mt-[18%] justify-center p-[1%]'>
