...
export default function ContactModal() {
  return (
    ...
    <div className="modal-box">
        <h3 className="font-bold text-lg text-black text-center">Fill out form to request an appointment</h3>
        ...
        <div className="modal-action flex justify-center">
            ...
            <label className="input input-bordered flex items-center gap-2 mb-[10px]" class="mb-[10px]">
                ...
                <input class="text-black" type="text" className="grow" placeholder="Name" name='name' />
            </label>
            <label className="input input-bordered flex items-center gap-2 mb-[10px]" class="mb-[10px]">
                ...
                <input class="text-black" type="email" className="grow" placeholder="Email" name='email' />
            </label>
            <label className="input input-bordered flex items-center gap-2 mb-[10px]" class="mb-[10px]">
                <input class="text-black" type="text" placeholder="Appointment Request" className="input input-bordered w-full max-w-xs" name='request' />
            </label>
