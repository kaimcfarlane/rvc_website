...
export default function ContactModal({text, placeholder, isJobForm, subText}) {
  ...
  return (
    <>
    <div className="modal-box bg-primary max-w-[100vw] w-[60vw] h-[26vw]">
        <div className="card lg:card-side bg-base-100 shadow-xl">
            <figure>
                <Image src={staff_pic} className='w-[35vw] h-[24vw]'></Image>
            </figure>
            <div className="card-body">
                    <div className="modal-action flex flex-col justify-center">
                        <h1 className="text-[1.5vw] leading-[2vw] text-black text-wrap text-center mb-[1.5vw]">{text}</h1>
