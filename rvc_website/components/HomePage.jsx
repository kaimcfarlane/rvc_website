...
export default function HomePage() {
  return (
    <section class="bg-[url('../public/rvc_office/rvc_officefloor.jpeg')] bg-cover bg-center h-[100vh] w-[100%] fixed">
      <div class='bg-opaque_white w-[490px] h-[120px] static ml-[60%] mt-[35%] rounded-md shadow-md'>
        <div class='flex text-black justify-center font-<K2D> text-3xl pt-[10px] pb-[27px]'>
        ...
        <div class='flex justify-center mt-[-15px] '>
          <button className="btn btn-wide btn-primary text-white font-<K2D> text-lg">Request Appointment</button>
        </div>
        <div></div>
      </div>
    </section>
